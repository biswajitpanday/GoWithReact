...
import { IForgetPasswordModel, IForgetPasswordProps, IForgetPasswordStateModel } from './models';
import { forgetPassword, reset, defaultForgetPasswordState } from './store';

export class ForgetPasswordComponent extends Component<IForgetPasswordProps, IForgetPasswordStateModel> {
    ...
    render() {
        return (
            <form>
                ...
                <button type="button" className="btn btn-dark btn-block" disabled={this.props.isBusy || !this.state.isValidForm} onClick={() => this.props.forgetPasswordRequestAction(this.state)}>Submit</button>
...
const mapDispatchToProps = (dispatch: any) => {
    return {
        forgetPasswordRequestAction: (forgetPasswordStateModel: IForgetPasswordModel) => dispatch(forgetPassword(forgetPasswordStateModel)),
