    ...
    return (
      <form>
        ...
        <button
          ...
          disabled={this.props.isBusy || !this.state.isFormValid}
          onClick={() => this.props.registrationRequestAction(this.state)}
        >
          Sign Up
        </button>
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    registrationRequestAction: (registrationState: IRegistrationState) =>
      dispatch(registration(registrationState)),
